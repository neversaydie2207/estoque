...
(function (global, factory) {
  ...
  /*
	 * Set hover, active and focus-states for buttons (source:
  ...
  // Remember state in cases where opening and handling a modal will fiddle
	// with it.
  var states = {
  ...
  function modalDependant () {
    ...
    return new Promise(function (resolve, reject) {
      ...
      // Get input element by specified type or, if type isn't specified, by
		// params.input
      ...
      function handleKeyDown (event) {
        ...
        var focusableElements = getFocusableElements(params.focusCancel)
        var btnIndex = -1 // Find the button - note, this is a nodelist, not
							// an array.
        for (var i = 0; i < focusableElements.length; i++) {
